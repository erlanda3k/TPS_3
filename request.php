            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Requestbarang</h1>
					  ...
					  <a href="exportrequest.php" class="btn btn-info"> Export DATA </a>
                      </div>  
                            <div class="card-body">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <br>
          <button type="submit" class="btn btn-primary" name="addnewbarangrequest"> Submit </button>
        </div>
        </form>
